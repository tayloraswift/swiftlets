...
do
{
    var dequeue = UnsafeDequeue<Int>()
    dequeue.appendFront(1)
    dequeue.appendFront(2)
    dequeue.appendFront(3)
    dequeue.appendFront(4)
    print(dequeue)
    dequeue.appendBack(10)
    dequeue.appendBack(11)
    print(dequeue)
    dequeue.popBack()
    print(dequeue)
    dequeue.popFront()
